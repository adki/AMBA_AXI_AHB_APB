...
`define BFM_DMA_TASKS_V
   //---------------------------------------------------------
   localparam CSRA_NAME0   = ADDR_DMA + 8'h00,
              CSRA_NAME1   = ADDR_DMA + 8'h04,
              CSRA_NAME2   = ADDR_DMA + 8'h08,
              CSRA_NAME3   = ADDR_DMA + 8'h0C,
              CSRA_COMP0   = ADDR_DMA + 8'h10,
              CSRA_COMP1   = ADDR_DMA + 8'h14,
              CSRA_COMP2   = ADDR_DMA + 8'h18,
              CSRA_COMP3   = ADDR_DMA + 8'h1C,
              CSRA_VERSION = ADDR_DMA + 8'h20,
              CSRA_CONTROL = ADDR_DMA + 8'h30,
              CSRA_NUM     = ADDR_DMA + 8'h40,
              CSRA_SOURCE  = ADDR_DMA + 8'h44,
              CSRA_DEST    = ADDR_DMA + 8'h48;
   //---------------------------------------------------------
   task csr_test;
   begin
   ...
   begin
       ...
       for (ad=src; ad<(src+bnum); ad=ad+1) begin
            be = (ad[1:0]==0) ? 4'b0001
               ...
               : (ad[1:0]==2) ? 4'b0100
               :                4'b1000;
            top.u_mem_axi.u_dpram.write(ad, dat, be);
...
//for (ad=src; ad<(src+bnum); ad=ad+1) begin
//top.u_mem_axi.u_dpram.read(ad, dat);
//end
